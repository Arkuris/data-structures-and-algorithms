...
test('Find first repeated word in a short sentence', () => {
  expect(repeatedWord("Once upon a time, there was a brave princess who...")).toBe("a");
});

test('Find first repeated word in a long paragraph', () => {
...
test('Find first repeated word with different capitalizations', () => {
...
test('Return null if no word is repeated', () => {
